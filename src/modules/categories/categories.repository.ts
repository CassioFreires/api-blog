...
  async findAll(): Promise<ICategory[]> {
    // OTIMIZAÇÃO: Consulta simples e direta para buscar todas as categorias.
    // Otimiza o desempenho por ser um método muito comum.
    try {
      return await db(this.tableName).select('*').orderBy('name', 'asc');
    } catch (error) {
